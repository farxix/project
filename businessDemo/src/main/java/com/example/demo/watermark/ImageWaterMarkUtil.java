...
public class ImageWaterMarkUtil {
    ...
    public static void main(String[] args) {
        String srcImgPath = "C:\\Users\\farxix\\Pictures\\view.jpg"; //原始文件地址
        String targetImgPath = "C:\\Users\\farxix\\Pictures\\view-copy.jpg"; //目标文件地址
        String text = "内 部 文 件 禁 止 外 传"; //水印文字内容
